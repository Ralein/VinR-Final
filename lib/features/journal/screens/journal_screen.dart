        ...
        if (remoteEntries.isNotEmpty) {
          ...
          for (final item in remoteEntries) {
            ...
            _savedEntries.add({
              ...
              'aiReflection': item['ai_response'] ?? 'Gratitude entry saved! Daily self-reflection strengthens emotional resilience.',
            });
          }
        }
      });
      ...
      body: AmbientBackground(
        child: SafeArea(
          child: ListView(
            ...
            children: [
              // Top Title Header Block (Matching Profile Screen Neat Style)
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      'Gratitude Journal',
                      style: VinRTypography.h1.copyWith(fontSize: 24, color: primaryTextColor),
                    ),
                  ),
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(LucideIcons.flame, size: 13, color: activeGold),
              ...
              // Centered User & Reflection Hero Card (Profile-Consistent Layout)
              Center(
                child: Column(
                  children: [
                    AvatarRing(
                    ...
                    child: GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(LucideIcons.penTool, size: 15, color: _viewMode == 'write' ? activeGold : mutedTextColor),
                    ...
                    child: GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Icon(LucideIcons.bookOpen, size: 15, color: _viewMode == 'entries' ? activeGold : mutedTextColor),
                            const SizedBox(width: 8),
                            Text(
                ...
                GlassContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(LucideIcons.smile, size: 17, color: VinRColors.gold),
                          const SizedBox(width: 8),
                          Text(
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'e.g. Morning coffee, warm sunshine, a warm text message...',
                          hintStyle: TextStyle(color: mutedTextColor.withValues(alpha: 0.7), fontSize: 12.5),
                ...
                GlassContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(LucideIcons.award, size: 17, color: VinRColors.emerald),
                          const SizedBox(width: 8),
                          Text(
                      ...
                      TextField(
                        ...
                        style: TextStyle(color: primaryTextColor, fontSize: 13.5),
                        decoration: InputDecoration(
                          hintText: 'e.g. Stayed focused on work, completed workout...',
                          hintStyle: TextStyle(color: mutedTextColor.withValues(alpha: 0.7), fontSize: 12.5),
                          border: InputBorder.none,
                        ),
                      ),
                ...
                GlassContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(LucideIcons.heartHandshake, size: 17, color: VinRColors.sapphire),
                          const SizedBox(width: 8),
                          Text(
                ...
                GlassContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(LucideIcons.penTool, size: 15, color: activeGold),
                          const SizedBox(width: 8),
                          Text(
                            'Free Reflection',
                      ...
                      TextField(
                        ...
                        maxLines: 4,
                        style: TextStyle(color: primaryTextColor, fontSize: 13.5, height: 1.4),
                        decoration: InputDecoration(
              ...
              // ENTRIES MODE
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Icon(LucideIcons.search, size: 17, color: mutedTextColor),
                ...
                if (_isLoading)
                  ...
                  Center(
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Icon(LucideIcons.bookOpen, size: 44, color: mutedTextColor.withValues(alpha: 0.4)),
                          const SizedBox(height: 12),
